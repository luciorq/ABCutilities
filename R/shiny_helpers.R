...
#'
#' @return Generates a \code{list} with a vector of labels that will be passed 
...
#' @export
#' 
select_factors <- function(in.df, max_nlevel = Inf, factor_class = NULL, keep_class = TRUE){
