...
#' @param att_of_interest string indicating which attribute value should be extracted,
...
#' function produces this from a list of, e.g., gene names for which the inter-
#' sections are to be determined.
#'
...
#' upset(ups_input, sets = names(ups_input))
#' 
#' @export
#' 
...
#'
#' @description To avoid crashing of \code{xlsx::write.xlsx()}.
#' Ideally, just make use of \code{openxlsx} instead of \code{xlsx},
